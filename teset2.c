...
int main()
{
    ...
    while (fgets(str, 2999, heroes))
    {
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->name = (char *)malloc((strlen(token) + 1) * sizeof(char));
       ...
       /*if (token != NULL)
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->full_name = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->alter_egos = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->aliases__001 = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->place_of_birth = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->first_appearance = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->publisher = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->alignment = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->gender = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->race = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->height__001 = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->height__002 = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->weight__001 = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->weight__002 = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->eye_color = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->hair_color = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->work__occupation = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->work__base = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->connections__group_affiliation = (char *)malloc((strlen(token) + 1) * sizeof(char));
        ...
        {
            token = strtok(NULL, ";");
            (heroPtr + i)->connections__relatives = (char *)malloc((strlen(token) + 1) * sizeof(char));
            strcpy((heroPtr + i)->connections__relatives, token);
        }
        muestrastruct((heroPtr+i));*/
        i++;

        if (i > len_file-2) break;
    }

    printf("\n\nPROBANDO\n");

    for (int i = 0; i < len_file-2; i++)
    {
        // printf("NAME: %s\n", heroPtr[i].name);
        muestrastruct(&heroPtr[i]);
    }
